...
def admin_login():
    ...
    cancel_button = Button(admin_login_frame, image=img14,
...
def main_window():
    ...
    black_button_student = Button(
        student_admin_frame, image=img11, bd=0, command=student_login, bg="#EBF2F8")
    black_button_student.place(x=100, y=300)
    black_button_teacher = Button(
        student_admin_frame, image=img12, bd=0, command=admin_login, bg="#EBF2F8")
